...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "洛脚本"; Text ="洛脚本"; Duration = 2; })
local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/zilinskaslandon/Where-Logan-boarded-the-ship./refs/heads/main/Luolibrary.lua"))();  
local win = ui:new("洛脚本")
--
